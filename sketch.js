...
function setup() {
  ...
  vid = createVideo("video asset 1.mp4");
...
pop ();
  ...
  image(vid,width/2,6300);

  text("In conclusion, after several experiments I was able to create a program that takes a still asset as input and warps the image each frame so that it produces a moving liquid effect in real-time. This is done without slowing down the browser, meaning it can be embedded on a webpage running continuously or exported as a video.",200,5450,700,height);
